...
public class BlogService {
    ...
    public BlogResponseDto createBlog(BlogRequestDto requestDto, HttpServletRequest request) {
        ...
        if (token != null) {
            ...
            Blog blog = blogRepository.saveAndFlush(new Blog(requestDto, user.getUsername(), user.getPassword(), user.getId()));
    ...
    public BlogResponseDto updateBlog(Long id, BlogRequestDto reqeustDto, HttpServletRequest request) {
